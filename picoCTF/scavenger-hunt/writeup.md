...
The remaining parts were found by accessing well-known sensitivefiles that are often accidentally exposed on web servers. Many parts in different modules show hints, so I need to use them.
...
**Found** ![flag3](../../.gitbook/assets/3-myjs-source-code.png) **Hint:** `/* How can I keep Google from indexing my website? */`
